...
export const SettingsSchema = z.object({
  ...
  privileges: z.object({ musicKnowledge: flag(true), googleSearch: flag(true), musicTaste: z.array(z.string().min(1).max(100)).max(100).default(['Radiohead','Kanye West','Pixies','Nirvana','Sublime','Weezer','Laufey','Creed','The Doobie Brothers','Tally Hall','King Von','ABBA','David Bowie','Duran Duran','Dominic Fike','BoyWithUke','Surf Curse','The Long Faces','Toby Fox','C418']) }).prefault({}),
